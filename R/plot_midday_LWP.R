...
lwp1 <- read.csv("Data/Hydraulics/WTC_TEMP_CM_PARRA_WATERPOTENTIAL-HEATWAVE_20161019-20161107_L0.csv")
...
legend("bottomleft",legend=c("Predawn-Control","Predawn-Heatwave","Midday-Control","Midday-Heatwave"),cex=0.9,
       pch=21,col=c("blue","black"),pt.bg=c("white","white","blue","black"),pt.cex=ptsize,ncol=2,bty="n")
box()
...
title(ylab=expression(Psi[L]~(MPa)),cex.lab=2)
legend("bottomleft",legend=c("Predawn-Control","Predawn-Heatwave","Midday-Control","Midday-Heatwave"),cex=0.9,
       pch=21,col=c("orange","red"),pt.bg=c("white","white","orange","red"),pt.cex=ptsize,ncol=2,bty="n")
box()
...
embolism <- read.csv("Data/Hydraulics/WTC_TEMP_CM_PARRA_NATIVE-EMBOLISM-HEATWAVE_20161018-20161104_L0_v2.csv")
